...
class Network():
    ...
    def update_mini_batch(self, mini_batch, eta):
        """Update the network's weight and biases by applying gradient
    ...
    def backprop(self, x, y):
        ...
        differently.
        Here, layer = 1 means the last layer of neurons, layer = 2 means
        the second-last layer, and so on."""
    ...
    def evaluate(self, test_data):
        ...
        Note that the neural network's output is assumed to be the index
